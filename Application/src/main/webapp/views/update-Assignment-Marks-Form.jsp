...
<html>
<head>
    <title>Update Assignment Scores</title>
...
<body>
    ...
    <c:set var="username" value="${pageContext.request.userPrincipal.name}" />
            ...
            <c:otherwise>
                <c:set var="formAction" value="${pageContext.request.contextPath}/trainer/saveAssignmentScore" />
            </c:otherwise>
            </c:choose>
    <div class="container">
                    ...
                    <tbody>
                        <c:forEach items="${trainees}" var="trainee">
                            <tr>
                                ...
                                <c:forEach items="${assignmentPlanDto.marksObtained}" var="parameter">
                                   <c:if test="${trainee.employeeId eq parameter.key}">
                                        ...
                                        <td>
                                            ...
                                            <div class="action-buttons" data-id="${trainee.employeeId}">
                                                ...
                                                <input type="hidden" name="assignmentId" value="${assignmentPlanDto.id}">
                                            </div>
                                        </td>
                                         <c:set var="found" value="true" scope="page"/>
                                   </c:if>
                                </c:forEach>
                                 <!-- Check the flag to determine if no matching entry was found -->
                                <c:choose>
