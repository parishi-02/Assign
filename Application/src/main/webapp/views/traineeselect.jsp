...
<html>
<head>
    <title>Add Trainees to Batch</title>
...
<body>
    ...
    <div class="container">
        <div class="table-container">
            <form:form method="post" action="${pageContext.request.contextPath}/admin/addTraineesToBatch" onsubmit="return validateSelection()">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2>Select Trainees to Add to Batch</h2>
                    <div>
