...
<body>
    ...
    <div class="container mt-5" style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap;">
        <h2>Batch List</h2>
        <button class="btn btn-primary fixbutton" onclick="redirectWithAdditionalParams('${pageContext.request.contextPath}/admin/batch-form');" style="color:white; text-decoration:none;">
            Create New Batch
        </button>
    </div>
    <hr>
...
<!-- Attendance Marks Modal -->
    ...
    <div class="modal fade" id="assignmentDetailsModal" tabindex="-1" role="dialog" aria-labelledby="assignmentDetailsModalLabel" aria-hidden="true">
     ...
     <!-- Assignment Marks Modal -->
    <!-- Modal -->
    <div class="modal fade" id="assessmentDetailsModalTrainee" tabindex="-1" role="dialog" aria-labelledby="assessmentDetailsModalTraineeLabel" aria-hidden="true">
      <div class="modal-dialog show-info-modal" role="document">
        <div class="modal-content show-info-modal-content">
          <div class="modal-header custom-modal-header">
            <h5 class="modal-title" id="assessmentDetailsModalTraineeLabel">Assessment Details</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
    ...
    <c:forEach items="${BatchDto}" var="batch">
        ...
        <div class="container mt-3 coursePlan-container" data-course-plan-id="${batch.batchId}">
            <div class="container mt-3" style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap;">
               <h2>Course Plan</h2>
               <button class="btn btn-primary fixbutton" onclick="redirectWithAdditionalParams('${pageContext.request.contextPath}/admin/downloadCoursePlan?batchId=${batch.batchId}','${batch.creationDate},'','download'');">
                                ...
                                <c:choose>
                                    <c:when test="${fn:contains(parameter.topics.topicName, 'HR INDUCTION')}">
                                        <div class="btn-group" role="group">
                                            <button class="btn btn-primary fixbutton" onclick="redirectWithAdditionalParams('${pageContext.request.contextPath}/admin/updateHRInduction?batchid=${batch.batchId}&topicName=${parameter.topics.topicName}&plannedDate=${parameter.plannedDate}','${batch.creationDate}');" style="color:white; text-decoration:none;">
                                                Update
                                            </button>
                                        </div>
                                    </c:when>
                                    ...
                                    <c:otherwise>
                                       <div class="btn-group" role="group">
                                           <button class="btn btn-primary fixbutton" onclick="checkPlannedDate('${parameter.plannedDate}','${pageContext.request.contextPath}/admin/updatePlannedDate?batchid=${batch.batchId}&topicName=${parameter.topics.topicName}&planId=${parameter.planId}&plannedDate=${parameter.plannedDate}','${batch.creationDate}');" style="color:white; text-decoration:none;">
                                              Update
                                           </button>
                                       </div>
                                    </c:otherwise>
        ...
        <div class="container mt-3 mentoring-container" data-course-plan-id="${batch.batchId}">
            <div class="container mt-3" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
                <h2>Mentoring List</h2>
                <div>
                    <button class="btn btn-primary fixbutton" onclick="redirectWithAdditionalParams('${pageContext.request.contextPath}/admin/mentoring-session-form?batchId=${batch.batchId}&batchStartDate=${batch.creationDate}','${batch.creationDate}');">
                       Add Mentoring Session
                    </button>
                    <button class="btn btn-primary fixbutton" onclick="redirectWithAdditionalParams('${pageContext.request.contextPath}/admin/downloadMentoringSession?batchId=${batch.batchId}','${batch.creationDate}','','download');">
                          Download Mentoring Session List
                    </button>
                </div>
            </div>
            <hr>
            <table id="mentoringTable-${batch.batchId}" class="table table-striped table-bordered" style="width:100%; font-size: small;">
                <thead class="thead-dark">
                    <tr>
                ...
                <tbody>
                    <c:forEach items="${batch.mentoringSessionDtos}" var="parameter">
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                   <button class="btn btn-primary fixbutton" onclick="checkPlannedDate('${parameter.plannedDate}','${pageContext.request.contextPath}/admin/updateMentoringSession?sessionId=${parameter.sessionId}','${batch.creationDate}');" style="color:white; text-decoration:none;">
                                     Update
                                   </button>
                                </div>
                            </td>
        ...
        <div class="container mt-3 assignment-container" data-course-plan-id="${batch.batchId}">
            <div class="container mt-3" style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap;">
               ...
               <button class="btn btn-primary fixbutton" onclick="redirectWithAdditionalParams('${pageContext.request.contextPath}/admin/downloadAssignmentList?batchId=${batch.batchId}','${batch.creationDate}','','download');">
                    ...
                    <c:forEach items="${batch.coursePlanDto.dayWisePlanDTOS}" var="parameter">
                        <c:if test="${not empty parameter.assignmentPlanDTO.description}">
                            <tr>
                                ...
                                <td style="width:80px;">
                                    <form class="edit-form" action="${pageContext.request.contextPath}/admin/updateAssignmentTotalMarks" method="post">
                                        <input type="hidden" name="id" value="${parameter.assignmentPlanDTO.id}"/>
                                        ...
                                        <span class="marks">${parameter.assignmentPlanDTO.totalScore}</span>
                                ...
                                <td style="width:300px;">
                                     <input type="hidden"  id="batchId2" value="${batch.batchId}"/>
        ...
        <div class="container mt-3 assessment-container" data-course-plan-id="${batch.batchId}">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <button class="btn btn-primary fixbutton" onclick="redirectWithAdditionalParams('${pageContext.request.contextPath}/admin/assessment-form?batchId=${batch.batchId}&batchStartDate=${batch.creationDate}','${batch.creationDate}');">
                       Add Assessment
                    </button>
                     <button class="btn btn-primary fixbutton"
                              onclick="redirectWithAdditionalParams('${pageContext.request.contextPath}/admin/downloadAssessments?batchId=${batch.batchId}', '${batch.creationDate}', '', 'download');">
                ...
                <tbody>
                    <c:forEach items="${batch.assessmentDTOS}" var="parameter">
                        <tr>
                            ...
                            <td style="width:300px;">
                               <button class="btn btn-primary fixbutton" onclick="checkPlannedDate('${parameter.plannedDate}','${pageContext.request.contextPath}/admin/updateAssessmentForm?assessmentId=${parameter.assessmentId}','${batch.creationDate}');" style="color:white; text-decoration:none;">
                                 Update
                               </button>
                                <button class="btn btn-success" onclick="checkActualDate('${parameter.actualDate}','${pageContext.request.contextPath}/admin/updateAssessmentMarks?assessmentId=${parameter.assessmentId}&batchId=${batch.batchId}','${batch.creationDate}');" style="color:white; text-decoration:none;">
                                   Upload Marks
                                 </button>
        ...
        <div class="container mt-3 attendance-container" data-course-plan-id="${batch.batchId}">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Attendance</h2>
                <button class="btn btn-primary fixbutton"
                      onclick="attendanceDownload('${pageContext.request.contextPath}/admin/downloadAttendance?batchId=${batch.batchId}', '${batch.creationDate}', '', 'download');">
                                              ...
                                              <tr>
                                                  ...
                                                  <td>
                                                      <c:choose>
                                                          ...
                                                          <c:otherwise>
                                                              <button type="button" class="btn btn-secondary" onclick="redirectWithAdditionalParams('${pageContext.request.contextPath}/admin/updateAttendanceForm?batchId=${batch.batchId}&attendanceDate=${parameter.plannedDate}','${batch.creationDate}');">Update Attendance</button>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <button type="button" class="btn btn-primary" onclick="redirectWithAdditionalParams('${pageContext.request.contextPath}/admin/updateAttendanceForm?batchId=${batch.batchId}&attendanceDate=${parameter.plannedDate}','${batch.creationDate}');">Mark Attendance</button>
                                                           <button type="button" class="btn btn-secondary" onclick="viewAttendance('${batch.batchId}','${parameter.plannedDate}');">View</button>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </td>
        ...
        <div class="container mt-3 trainee-container" data-course-plan-id="${batch.batchId}">
            <div class="container mt-3" style="display: flex; justify-content: space-between; align-items: baseline; flex-wrap: wrap;">
                <h2>Trainee List</h2>
                <div>
                    <button class="btn btn-primary fixbutton"  onclick="handleTraineeClick('${pageContext.request.contextPath}/admin/addTrainee?batchId=${batch.batchId}','${batch.creationDate}');">
                       Add Trainee
                    </button>
                    <button class="btn btn-primary fixbutton" data-action="updateTrainee" id="updateTrainee" onclick="handleTraineeClick('${pageContext.request.contextPath}/admin/updatebatchtrainee?batchId=${batch.batchId}','${batch.creationDate}');" style="color:white; text-decoration:none;">
                        Update Trainee
                    </button>
                    <button class="btn btn-primary fixbutton" onclick="handleTraineeClick('${pageContext.request.contextPath}/admin/traineeReport?batchId=${batch.batchId}');" style="color:white; text-decoration:none;">
                        Trainee Report
                    </button>
                </div>
            </div>
   ...
   <!-- Spinner for form submission -->
    ...
    // Declare and initialize divTypeValue and batchTypeValue at the beginning
      ...
      function checkPlannedDate(plannedDate,basePath,batchCreationDate)
      {
        ...
        if (currentDateObj < plannedDateObj) {
            showValidationModal('Error', 'Planned Date is ' + plannedDate + " so you cannot update Actual date before the planned date.");
        } else {
    ...
    function attendanceDownload(basePath,batchCreationDate,traineeFlag,buttonName)
    {
      ...
      function handleTraineeClick(basePath,batchCreationDate) {
          // Convert the batchCreationDate to a Date object
              var batchDate = new Date(batchCreationDate);
              var currentDate = new Date();
              batchDate.setHours(0, 0, 0, 0);
              currentDate.setHours(0, 0, 0, 0);
              var traineeFlag = 'false';

            // Check if batchCreationDate is less than the current date
            if (batchDate <= currentDate) {
                // Hide the spinner
                document.getElementById('loading').style.display = 'none';
                // Show alert and exit function
                showValidationModal('Error','Batch is Already Started..You cannot add Trainee now.');
                return; // Stop execution
            }
            else
            {
                redirectWithAdditionalParams(basePath,batchCreationDate,traineeFlag);
            }
          }
      ...
      window.addEventListener('popstate', function() {
        ...
        document.querySelectorAll('.update-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                const marksSpan = row.querySelector('td .marks');
                const marksInput = row.querySelector('td input[name="totalMarks"]');
                  ...
                  var batchDate = new Date(batchCreationDate);
                   ...
                   else
                   {
                     if (this.textContent === 'Update') {
                        ...
                        const currentValue = marksSpan.textContent.trim();
                        marksInput.value = currentValue;
                    ...
                    // Validate the input before saving
                      ...
                      else
                      {
                        ...
                        $('#divType').val(divTypeValue);
                        $('#batchType').val(batchTypeValue);

                        alert("div = " + $('#divType').val());
            ...
            button.addEventListener('click', function() {
                ...
                marksInput.value = marksSpan.textContent.trim();
                marksInput.classList.add('d-none');
                marksSpan.classList.remove('d-none');
               ...
               else
               {
                    ...
                    if (!totalMarksValue) {
                        ...
                        // If value is present, navigate to the URL
                         var ur = "${pageContext.request.contextPath}/admin/updateAssignmentMarks?assignmentId=" + assignmentId + "&batchId=" + batchTypeValue;
    ...
    <!--Assignment Marks View Modal -->
    function viewAssignmentDetails(assignmentId) {
        var loading = document.getElementById('loading');
        loading.style.display = 'block'; // Show the spinner
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/viewTraineesAssignmentMarks",
            type: "GET",
    ...
    function viewAssessmentDetails(assessmentId) {
         ...
         loading.style.display = 'block'; // Show the spinner
        $.ajax({
            url: "${pageContext.request.contextPath}/admin/viewTraineesAssessmentMarks",
            type: "GET",
    ...
    function viewAttendanceDetails(assignmentId) {
        ...
        loading.style.display = 'block'; // Show the spinner
           $.ajax({
               url: "${pageContext.request.contextPath}/admin/getTraineeAttendance",
               type: "GET",
          ...
          function viewAssignmentMarksDetails(assignmentId) {
           var loading = document.getElementById('loading');
            loading.style.display = 'block'; // Show the spinner
            $.ajax({
                url: "${pageContext.request.contextPath}/admin/getTraineeAssignment",
                type: "GET",
                data: {traineeId: assignmentId},
                success: function(data) {
                if(data.error)
          ...
          function viewAssessmentMarksDetails(assignmentId) {
             var loading = document.getElementById('loading');
              ...
              loading.style.display = 'block'; // Show the spinner
              $.ajax({
                  url: "${pageContext.request.contextPath}/admin/getTraineeAssessment",
                  type: "GET",
                  data: {traineeId: assignmentId},
                  success: function(data) {
                    if(data.error)
                          ...
                          // Loop through the map and append each key-value pair as a table row
                            ...
                            // Extract the relevant parts from the key string
                               ...
                               if (descriptionMatch && totalScoreMatch) {
                                 ...
                                 // Show the modal
                                 $('#assessmentDetailsModalTrainee').modal('show');
                             } else {
                                 console.error('Data missing expected properties:', data);
                                 alert('Error: Data does not contain expected properties.');
                             }
        ...
        function viewAttendance(batchId, plannedDate) {
            ...
            loading.style.display = 'block'; // Show the spinner
           $.ajax({
               url: `${pageContext.request.contextPath}/admin/getAttendancePerDay`,
               type: "GET",
               data: {
                   batchId1: batchId,
