...
<div class="sidebar">
    ...
    <sec:authorize access="hasRole('ROLE_ADMIN')">
                <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" aria-expanded="false"
                    onclick="window.location.href='${pageContext.request.contextPath}/admin/showAllBatches';" style="color: blue;">
                    Batches
                </button>
            </sec:authorize>

            <!-- Trainer Button for Admin -->
                   <sec:authorize access="hasRole('ROLE_ADMIN')">
                       <button id="sidebarTrainer" class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" aria-expanded="false"
                           onclick="window.location.href='${pageContext.request.contextPath}/admin/viewTrainer';" style="color: blue;">
                           Trainer
                       </button>
                   </sec:authorize>

                   <!-- Trainee Button for Admin -->
                   <sec:authorize access="hasRole('ROLE_ADMIN')">
                       <button id="sidebarTrainee" class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" aria-expanded="false"
                           onclick="window.location.href='${pageContext.request.contextPath}/admin/viewTrainee';" style="color: blue;">
                           Trainee
                       </button>
                   </sec:authorize>


            <!-- Trainer-Dashboard Button for Trainer -->
                    <sec:authorize access="hasRole('ROLE_TRAINER')">
                        <button id="sidebarTrainee" class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" data-bs-target="#trainee" aria-expanded="false"
          ...
          <!-- Trainee-Dashboard Button for Trainee -->
                  <sec:authorize access="hasRole('ROLE_TRAINEE')">
                      <button id="sidebarTrainee" class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed" data-bs-toggle="collapse" data-bs-target="#trainee" aria-expanded="false"
                          onclick="window.location.href='${pageContext.request.contextPath}/trainee/showAllBatches';" style="color: blue;">
                          Batch
                      </button>
                  </sec:authorize>
